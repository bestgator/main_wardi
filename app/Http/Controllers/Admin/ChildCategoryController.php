...
class ChildCategoryController extends Controller
{
   public function __construct()
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->addColumn('category', function(Childcategory $data) {
                                return $data->subcategory->category->name_en;
                            })
                            ->addColumn('subcategory', function(Childcategory $data) {
                                return $data->subcategory->name_en;
                            })
    ...
    public function destroy($id)
    {
        ...
        // $msg = 'Remove the Attributes first !';
        // return response()->json($msg);
        \DB::table('attributes')->join('attribute_options','attribute_options.attribute_id','=','attributes.attributable_id')->where('.attributes.attributable_type','App\Models\Childcategory')->delete() ;
        //--- Redirect Section Ends
        }
        ...
        {
        //--- Redirect Section
        \DB::table('products')->where('products.childcategory_id',$id)->delete();
        // $msg = 'Remove the products first !';
        // return response()->json($msg);
        //--- Redirect Section Ends
        }
