...
class CategoryController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('productss', function(Category $data) {
                                $buttonss = '<div class="action-list"><a href="' . route('admin-category-products', $data->id) . '" class="attribute" >Show Products</a>';
                                 $buttonss .= '</div>';
                                return $buttonss;
                            })
                            ...
                            ->rawColumns(['status','attributes','productss','action'])
    ...
    public function destroy($id)
    {
        ...
        // return response()->json($msg);
        \DB::table('attributes')->join('attribute_options','attribute_options.attribute_id','=','attributes.attributable_id')->where('.attributes.attributable_type','App\Models\Category')->delete() ;
        //--- Redirect Section Ends
        }
        ...
        // return response()->json($msg);
        \DB::table('subcategories')->join('childcategories','childcategories.subcategory_id','=','subcategories.id')->where('subcategories.category_id',$id)->delete() ;
        //--- Redirect Section Ends
        }
        if($data->products->count()>0)
        {
        //--- Redirect Section
        \DB::table('products')->join('categories','categories.id','=','products.category_id')->where('products.category_id',$id)->delete();
