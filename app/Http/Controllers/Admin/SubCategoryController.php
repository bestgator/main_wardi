...
class SubCategoryController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        // $msg = 'Remove the Attributes first !';
        // return response()->json($msg);
        \DB::table('attributes')->join('attribute_options','attribute_options.attribute_id','=','attributes.attributable_id')->where('.attributes.attributable_type','App\Models\Subcategory')->delete() ;
        //--- Redirect Section Ends
        }
        ...
        // return response()->json($msg);
        \DB::table('childcategories')->where('subcategory_id',$id)->delete() ;
        //--- Redirect Section Ends
        }
        if($data->products->count()>0)
        {
        //--- Redirect Section
        \DB::table('products')->where('products.subcategory_id',$id)->delete();
        // $msg = 'Remove the products first !';
        // return response()->json($msg);
        //--- Redirect Section Ends
        }
