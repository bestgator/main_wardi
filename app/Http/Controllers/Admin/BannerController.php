...
class BannerController extends Controller
{
    ...
    public function top()
    {
        return view('admin.banner.top');
    }
    
    public function homeCat()
    {
        return view('admin.banner.homecat') ;
    }
    ...
    {
        return view('admin.banner.topcreate');
    }

    public function homecatcreate()
    {
        return view('admin.banner.homecatcreate');
    }
