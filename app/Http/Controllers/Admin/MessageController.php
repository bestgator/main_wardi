...
class MessageController extends Controller
{
    ...
    public function datatables($type)
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('sendername', function(AdminUserConversation $data) {
                                $name = $data->name;
                                return  $name;
                            })
                            ->editColumn('photo', function(AdminUserConversation $data) {
                                $photo = $data->photo ? url('assets/images/preception/'.$data->photo):url('assets/images/noimage.png');
    ...
    {
        return view('admin.message.prescription'); 
    }
