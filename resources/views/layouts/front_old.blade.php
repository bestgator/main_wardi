...
@endif -->
			...
			<div class="row">
				<div class="col-lg-12 remove-padding">
					<div class="content">
						...
						<p style="top: 27px;left: 792px;height: 20px;text-align: left;font: normal normal bold  17px/8px  Tajawal;letter-spacing: 0px;color: #FFFFFF;opacity: 1;">@if(Session::get('language') == '2') أفضل العروض و الخصومات من صيدليات وردى  @else Best offers and discounts from Wardi Pharmacy @endif <button  style="top: 20px;left: 204px;width: 277px;height: 49px;margin-top:5px;margin-right: 20px ; background: #FFFFFF 0% 0% no-repeat padding-box;border-radius: 10px;opacity: 1;"><h3 style="top: 28px;left: 572px;height: 44px;font: normal normal bold 30px/44px Tajawal;letter-spacing: 0px;color: #ED64A5;opacity: 1;text-align: center;">@if(Session::get('language') == '2' ) تسوق الان    @else Shop Now @endif</h3>
						</button></p>	
				</div>
			</div>
		</div>
				...
				<div class="col-lg-4 col-sm-12 remove-padding order-last order-sm-2 order-md-2">
					<div class="search-box-wrapper">
						<div class="search-box">
							...
							<form id="searchForm" class="search-form" style="border: 1px solid #ED64A5;border-radius: 10px;opacity: 1; " action="{{ route('front.category', [Request::route('category'),Request::route('subcategory'),Request::route('childcategory')]) }}" method="GET">
	...
	<div class="mainmenu-area mainmenu-bb" style="height:50px">
		<div class="container">
			<div class="row align-items-center mainmenu-area-innner py-1">
...
@yield('content')
	...
	<div class="col-lg-12" style="background: #ED64A5 0% 0% no-repeat padding-box;opacity: 1;">
        		...
        		<div class="row ">
        			...
        			<div class="col-lg-6">
						<h2 style="text-align: right;font: normal normal bold 50px/84px Tajawal;letter-spacing: 0px;color: #FFFFFF;opacity: 1;">@if(Session::get('language') == '2')  حمل تطبيق صيدليات وردى  @else Download Wardi Pharmacy App @endif</h2>
						<h3 style="text-align: right;font: normal normal medium 35px/50px Tajawal;letter-spacing: 0px;color: #FFFFFF;opacity: 1;"> @if(Session::get('language') == '2') الآن يمكنك طلب وجدولة كل احتياجاتك من الأدوية ومستحضرات التجميل ومنتجات العناية الشخصية لتصلك على عنوانك من أقرب صيدلية في منطقتك.  @else Now you can get personal care cosmetics at your address from the nearest pharmacy in your area. @endif</h3>

						<br>
							<br>
						<div style="top: 12730px;left: 1500px;width: 100%;height: 94px;">
							<a href="#" >
								<img src="{{asset('assets/images/appStore.png')}}" alt="" style="width: 30%;height: 80px;">
							</a>
							
							<a href="#" >
								<img src="{{asset('assets/images/googlePlay.png')}}" alt="" style="width:30%;height: 80px;">
							</a>
						</div>
		...
		<div class="container">
			<div class="row" >
				<div class="col-md-6 col-lg-3" >
						...
						<div class="text">
							<p style="text-align: left;font: normal normal 800 30px/49px Tajawal;letter-spacing: 0px;color: #ED64A5;opacity: 1;">
								@if(Session::get('language') == '1') {!! $gs->footer !!} @else صيدليات وردى  @endif
							</p>
						</div>								
				</div>
				...
				<div class="col-md-6 col-lg-3" >
					<div class="footer-widget info-link-widget">
						...
						<ul class="link-list" >
							<li >
								<a href="{{ route('front.index') }}" style="text-align: right;font: normal normal normal 20px/36px Tajawal;letter-spacing: 0px;color: #464646;opacity: 1;">
									<i class="fas fa-angle-double-right"></i>{{ $langg->lang22 }}
								</a>
							</li>

							<li>
								<a href="{{ route('front.contact') }}" style="text-align: right;font: normal normal normal 20px/36px Tajawal;letter-spacing: 0px;color: #464646;opacity: 1;">
									<i class="fas fa-angle-double-right"></i>{{ $langg->lang23 }}
								</a>
							</li>

							<li>
								<a href="{{ route('front.pharmacy') }}" style="text-align: right;font: normal normal normal 20px/36px Tajawal;letter-spacing: 0px;color: #464646;opacity: 1;">
									<i class="fas fa-angle-double-right"></i>{{ $langg->lang531 }}
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="col-md-6 col-lg-3" >
					<div class="footer-widget info-link-widget">
						...
						<ul class="link-list" >
							...
							<li >
								<a href="{{ route('front.page',$data->slug) }}" style="text-align: right;font: normal normal normal 20px/36px Tajawal;letter-spacing: 0px;color: #464646;opacity: 1;">
									<i class="fas fa-angle-double-right"></i>@if($langg->rtl == "1") {{ $data->title }} @else {{ $data->slug }} @endif
								</a>
							</li>
							@endforeach
						</ul>
				...
				<div class="col-md-6 col-lg-2" >
					<div class="fotter-social-links">
							<ul>
                              ...
                              <li>
                                <a href="{{ App\Models\Socialsetting::find(1)->facebook }}" class="facebook" target="_blank" style="background:#ED64A5;color: white;">
                              ...
                              <li>
                                <a href="{{ App\Models\Socialsetting::find(1)->twitter }}" class="twitter" target="_blank" style="background:#ED64A5;color: white;">
                              ...
                              <li>
                                <a href="{{ App\Models\Socialsetting::find(1)->linkedin }}" class="linkedin" target="_blank" style="background:#ED64A5;color: white;">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-9">
							<div class="content">
								<div class="content" >
									<p style="text-align: right;letter-spacing: 0px;color: #464646;opacity: 1;">{!! $gs->copyright !!}</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
