                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-sb-store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="tags" placeholder="{{ __('TAGS') }}" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="discount_precentage" placeholder="{{ __('DISCOUNT') }}" value="">
                          </div>
                        </div>
