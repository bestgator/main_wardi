                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-shipping-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_ar" placeholder="{{ __('Title Arabic') }}" required="" value="{{ $data->title_ar }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Price Inside Gada') }} *</h4>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Price Outside Gada') }} *</h4>
                                <p class="sub-heading">({{ __('In') }} {{ $sign->name }})</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="price_out" placeholder="{{ __('Price Out Gada') }}" required="" value="{{ $data->price_out * $sign->value }}" min="0" step="0.01">
                          </div>
                        </div>
