							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li><a href="javascript:;">{{ __('Manage Branches') }}</a></li>
                        ...
                        @include('includes.admin.form-success')
										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
				                        <th width="20%">{{ __('Branch Name EN') }}</th>
				                        <th width="20%">{{ __('Branch Name AR') }}</th>
				                        <th width="20%">{{ __('City Name EN') }}</th>
				                        <th width="20%">{{ __('City Name AR') }}</th>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-branches-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-branch-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
