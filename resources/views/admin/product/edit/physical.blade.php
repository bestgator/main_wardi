...
@section('content')
                        ...
                        @include('includes.admin.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<input type="text" class="input-field" placeholder="{{ __('Enter Product Name ENGLISH') }}" name="name_en" required="" value="{{ $data->name_en }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<input type="text" class="input-field" placeholder="{{ __('Enter Product Name Arabic') }}"
                                              ...
                                              @foreach($cats as $cat)
                                                  <option data-href="{{ route('admin-subcat-load',$cat->id) }}" value="{{$cat->id}}" {{$cat->id == $data->category_id ? "selected":""}} >{{$cat->name_en}}</option>
                                              @endforeach
						                                     </select>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-12">
	                                                  ...
	                                                  <option data-href="{{ route('admin-childcat-load',$sub->id) }}" value="{{$sub->id}}" >{{$sub->name_en}}</option>
	                                                  @endforeach
	                                                  @else
	                                                  @foreach($data->category->subs as $sub)
	                                                  <option data-href="{{ route('admin-childcat-load',$sub->id) }}" value="{{$sub->id}}" {{$sub->id == $data->subcategory_id ? "selected":""}} >{{$sub->name_en}}</option>
	                                                  @endforeach
	                                                  @endif
												...
												<div class="row">
													...
													<div class="col-lg-12">
	                                                  ...
	                                                  @else
	                                                  @foreach($data->subcategory->childs as $child)
	                                                  <option value="{{$child->id}} " {{$child->id == $data->childcategory_id ? "selected":""}}>{{$child->name_en}}</option>
	                                                  @endforeach
	                                                  @endif
	                                                  @endif
															</select>
											...
											<div class="{{ $data->measure == null ? 'showbox' : '' }}">
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="text-editor">
															<textarea name="details" class="nic-edit-p">{{$data->details_ar}}</textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="text-editor">
															<textarea name="policy" class="nic-edit-p">{{$data->policy_en}}</textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="text-editor">
															<textarea name="policy" class="nic-edit-p">{{$data->policy_ar}}</textarea>
														</div>
													</div>
												</div>
