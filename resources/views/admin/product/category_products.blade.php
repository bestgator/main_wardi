							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="javascript:;">{{ App\Models\Category::where('id',$id)->pluck('name_en')->first() }} </a>
											</li>
											<li>
                        ...
                        @include('includes.admin.form-success')  
										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
														    <th><input type="checkbox" name="bulkdelete[]" id="checkAll"></th>
														    <th>Brand Name</th>
														    <th>Category Name</th>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-prod-datatables95',$id) }}',
               columns: [
                        { data: 'bulk', name: 'bulk' },
                        { data: 'b_name', name: 'b_name' },
                        { data: 'cat_name', name: 'cat_name' },
                        { data: 'scat_name', name: 'scat_name' },
                        { data: 'ccat_name', name: 'ccat_name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="#" data-toggle="modal" data-target="#categoryMove">'+
          '<i class="fas fa-plus"></i> <span class="remove-mobile">{{ __("Change Category") }}<span>'+
          '</a>'+'<a class="add-btn" href="#" data-toggle="modal" data-target="#confirm-delete_bulk">'+
