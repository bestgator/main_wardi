<li>
    ...
    <li>
        <a href="#menu33" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-cart"></i>{{ __('Brands') }}
        </a>
 ...
 -->
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="msg" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-message-prescription') }}"><span>{{ __('Prescription Requests') }}</span></a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="homepage" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-top-bottom') }}"><span>{{ __('Three Top Banners') }}</span></a>
            </li>

            <li>
                <a href="{{ route('admin-home-categories') }}"><span>{{ __('Home Categories') }}</span></a>
            </li>
    ...
    <li>
        <a href="{{ route('admin-branches-index') }}" class=" wave-effect"><i class="fas fa-user-secret"></i>{{ __('Branches') }}</a>
    </li>
