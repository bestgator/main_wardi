															...
															<div class="right-area">
																	<div class="stars">
					                                                  <div class="ratings">
																		...
																		<h4 class="price">{{ $prod->showPrice() }} @if($prod->previous_price != $prod->price) <del>{{ $prod->showPreviousPrice() }}</del> @endif</h4>
																		<p class="text"><a href="{{ route('front.product',$prod->slug) }}">{{ mb_strlen($prod->nameLang(),'utf-8') > 35 ? mb_substr($prod->nameLang(),0,35,'utf-8').'...' : $prod->nameLang() }}</a></p>
															</div>
														</div>
													</li>
