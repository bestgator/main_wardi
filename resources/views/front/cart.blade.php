                    ...
                    <tr class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}">
                      <td class="product-img">
                        <div class="item">
                          ...
                          <p class="name"><a href="{{ route('front.product', $product['item']['slug']) }}">@if(Session::get('language') == '1') {{mb_strlen($product['item']['name_en'],'utf-8') > 35 ? mb_substr($product['item']['name_en'],0,35,'utf-8').'...' : $product['item']['name_en']}} @else {{mb_strlen($product['item']['name_ar'],'utf-8') > 35 ? mb_substr($product['item']['name_ar'],0,35,'utf-8').'...' : $product['item']['name_ar']}} @endif</a></p>
                        </div>
                      </td>
                                            <!--<td>-->
