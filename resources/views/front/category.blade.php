...
<div class="breadcrumb-area" @if (!empty($cat)) style="background: url('{{asset('assets/images/categories/'.$cat->photo)}}') no-repeat scroll center center  ;height: 100px" @endif>
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
            <ul class="pages">
