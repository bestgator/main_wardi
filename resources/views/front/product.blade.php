    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="pages">
          ...
          <li><a href="{{route('front.category',$productt->category->slug)}}">{{$productt->category->nameLang()}}</a></li>
          @if($productt->subcategory_id != null)
          <li><a
              href="{{ route('front.subcat',['slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug]) }}">{{$productt->subcategory->nameLang()}}</a>
          </li>
          @endif
          @if($productt->childcategory_id != null)
          <li><a
              href="{{ route('front.childcat',['slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug, 'slug3' => $productt->childcategory->slug]) }}">{{$productt->childcategory->nameLang()}}</a>
          </li>
          @endif
          <li><a href="{{ route('front.product', $productt->slug) }}">{{ $productt->nameLang() }}</a>
        ...
        <div class="row">
          ...
          <div class="xzoom-container">
            ...
            <div class="col-lg-7">
              <div class="right-area">
                <div class="product-info">
                  <h4 class="product-name">{{ $productt->nameLang() }}</h4>
            ...
            <div class="product-price">
              <p class="title" style="font-family: 'Tajawal';">{{ $langg->lang87 }} :</p>
                    <p class="price" style="font-family: 'Tajawal';"><span id="sizeprice">{{ $productt->showPrice() }}</span>
                      @if($productt->previous_price != $productt->price) <del>{{ $productt->showPreviousPrice() }}</del> @endif</p>
                  ...
                  <div class="product-size">
                    <p class="title" style="font-family: 'Tajawal';">{{ $langg->lang88 }} :</p>
                    <ul class="siz-list">
                      @php
                      $is_first = true;
                      @endphp
                  ...
                  <div class="product-color">
                    <p class="title" style="font-family: 'Tajawal';">{{ $langg->lang89 }} :</p>
                    <ul class="color-list">
                      @php
                      $is_first = true;
                      @endphp
                  ...
                  <a href="https://api.whatsapp.com/send/?phone=966543504864&text&app_absent=0" target="blank" >@if(Session::get('language') == '1' ) Talk to doctor now @else تحدث الى طبيب الان  @endif
                  ...
                  <div id="product-details-tab">
                    <div class="top-menu-area">
                      <ul style="display: flex; flex-wrap: wrap;" class="tab-menu">
                        <li><a href="#tabs-1" style="font-size: 13px; font-family: 'Tajawal';">{{ $langg->lang92 }}</a></li>
                        <li><a href="#tabs-2" style="font-size: 13px;font-family: 'Tajawal';">{{ $langg->lang93 }}</a></li>
                        <li><a href="#tabs-3" style="font-size: 13px;font-family: 'Tajawal';">{{ $langg->lang94 }}({{ count($productt->ratings) }})</a></li>
                        @if($gs->is_comment == 1)
                        <li><a style="font-size: 13px;font-family: 'Tajawal';" href="#tabs-4">{{ $langg->lang95 }}(<span
                              id="comment_count" style="font-family: 'Tajawal';">{{ count($productt->comments) }}</span>)</a></li>
                        @endif
                      </ul>
                    </div>
                    <div class="tab-content-wrapper">
                      <div id="tabs-1" class="tab-content-area">
                        <p>{!! $productt->detailsLang() !!}</p>
                      </div>
                      <div id="tabs-2" class="tab-content-area">
                        <p>{!! $productt->policyLang() !!}</p>
                      </div>
    ...
    <div class="row">
      <div class="col-lg-12 remove-padding">
        <div class="trending-item-slider">
          @foreach(App\Models\Product::where('category_id',$productt->category_id)->where('status','=',1)->where('id','!=',$productt->id)->take(10)->get()
          as $prod)
