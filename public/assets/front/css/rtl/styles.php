...
ul.wardi-mega-menu li.dropdown_list:nth-of-type(5),
ul.wardi-mega-menu li:last-child {
    display: none;
}
...
ul.wardi-mega-menu li.dropdown_list .link-area a i {
    float: left;
    margin-left: 1em;
}


ul.wardi-mega-menu li.dropdown_list:first-child .link-area a i {
    float: right;
}

ul.wardi-mega-menu li.dropdown_list {
    padding: 0 1em;
}
...
ul.categories_mega_menu.d-block {
    display: block !important;
}

button.toggle-bar.mobile-menu {
    border: 0;
    background: unset;
